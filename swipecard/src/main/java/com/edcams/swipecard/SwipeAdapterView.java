...
public class SwipeAdapterView extends BaseSwipeAdapterView{
    ...
    private float ROTATION_DEGREES = 15.5f;
    ...
    public SwipeAdapterView(Context context, AttributeSet attributeSet, int defStyle){
        super(context, attributeSet, defStyle);
        TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.SwipeFlingAdapterView, defStyle, 0);
    ...
    public void init(final Context context, Adapter adapter){
    ...
    private void layoutChildren(int startingIndex, int adapterCount){
        while (startingIndex < Math.min(adapterCount, MAX_VISIBLE) ) {
            View newUnderChild = adapter.getView(startingIndex, null, this);
    ...
    private void setTopView() {
        if(getChildCount()>0){
            ...
            if(mActiveCard!=null) {
                ...
                flingCardListener = new FlingCardListener(mActiveCard, adapter.getItem(0),
